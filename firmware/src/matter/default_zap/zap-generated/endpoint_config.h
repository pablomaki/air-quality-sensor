...
#define GENERATED_ATTRIBUTES                                                   \
  {                                                                            \
      ...
      {ZAP_EMPTY_DEFAULT(), 0x0000001A, 1, ZAP_TYPE(ENUM8),                    \
       ZAP_ATTRIBUTE_MASK(READABLE)}, /* BatChargeState */                     \
      {ZAP_EMPTY_DEFAULT(), 0x0000001C, 1, ZAP_TYPE(BOOLEAN),                  \
      ...
      {ZAP_SIMPLE_DEFAULT(6), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),               \
       ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                         \
      {ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                   \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */                \
      ...
      {ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                   \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */                \
                                                                               \
      /* Endpoint: 4, Cluster: Air Quality (server) */                         \
      {ZAP_EMPTY_DEFAULT(), 0x00000000, 1, ZAP_TYPE(ENUM8),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
      ...
      {ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                 \
       ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */                    \
                                                                               \
      /* Endpoint: 4, Cluster: Carbon Dioxide Concentration Measurement        \
         (server) */                                                           \
...
#define GENERATED_CLUSTERS { \
  ...
  { \
      /* Endpoint: 4, Cluster: Carbon Dioxide Concentration Measurement (server) */ \
...
#define GENERATED_ENDPOINT_TYPES                                               \
  {                                                                            \
      {ZAP_CLUSTER_INDEX(0), 12, 90}, {ZAP_CLUSTER_INDEX(12), 3, 12},          \
      {ZAP_CLUSTER_INDEX(15), 3, 12}, {ZAP_CLUSTER_INDEX(18), 3, 12},          \
      {ZAP_CLUSTER_INDEX(21), 4, 4},                                           \
  }
...
#define FIXED_DEVICE_TYPES                                                     \
  {{0x00000012, 1}, {0x00000016, 4}, {0x00000302, 1},                          \
   {0x00000307, 1}, {0x00000305, 1}, {0x0000002C, 1}}
