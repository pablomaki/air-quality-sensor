...
// Use this macro to check if the server side of the Air Quality cluster is
// included
...
// Use this macro to check if the server side of the Pressure Measurement
// cluster is included
...
// Use this macro to check if the server side of the Carbon Dioxide
